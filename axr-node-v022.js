// ═══════════════════════════════════════════════════════════════════════════════
// AXR Receipt Generator - N8N Code Node v0.2.2 (chain-fix)
// ═══════════════════════════════════════════════════════════════════════════════
...
//
// VALTOZASOK a v0.2-hoz kepest (2026-06-10, audit utan):
//
...
const AXR_DIR = process.env.AXR_DIR || '/home/node/.n8n/axr';
...
const STEP_NODES = [
  ...
  { node: 'The Brain (Logic)',      readFrom: 'The Brain (Logic)',
    type: 'n8n-nodes-base.code',          logic_version: '5.1 HU',
    logic_hash: 'sha256:9a31f43fddd0107710ef07bdab54bc9efcc5ddc97817ef444cdfb5244f6bfec3' },
