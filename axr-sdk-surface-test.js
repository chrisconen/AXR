...
const NAMESPACES = {
  ...
  governance: ['keyFingerprint', 'buildTrustRoot', 'buildQuorumTrustRoot', 'verifyTrustRoot',
               ...
               'buildWitnessRevocation', 'buildQuorumWitnessRevocation', 'verifyWitnessRevocation', 'revokedWitnessesAt',
               'buildWitnessSuspension', 'buildQuorumWitnessSuspension', 'verifyWitnessSuspension', 'suspendedWitnessesAt'],
  ...
  control: ['verifyControlRecord', 'verifyControlLog', 'controlRoot', 'checkSthCommitment', 'checkControlConsistency',
            'buildControlDisclosure', 'verifyControlDisclosure'],
